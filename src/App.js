...
function App() {
  ...
  const sortedTodos = sortCriteria === "Priority"
  ...
  return (
    <div className="App">
      ...
      {!isCompleteScreen && <div className="header">
        <input
          type="text"
      ...
      <div className="todo-wrapper">
        ...
        <div className="btn-area">
          ...
          <button
            ...
            onClick={() => {setIsCompleteScreen(true); setSortCriteria("Default"); setSearchTerm("")}}
          >
            Completed
          </button>
        </div>
        ...
        { (sortCriteria!=="Default" || searchTerm.length!==0) && sortedTodos.map((item, index) => (
         ...
         {(isCompleteScreen===false && sortCriteria==="Default" && searchTerm.length===0) && allTodos.map((item,index)=>{
          return(
            <div className="todo-list-item" key={index}>
            <div>
              <h3>{item.title}</h3>
         ...
         {(isCompleteScreen===true && sortCriteria==="Default") && completedTodos.map((item,index)=>{
          return(
            <div className="todo-list-item" key={index}>
            <div>
              <h3>{item.title}</h3>
